...
| Name                                                 | Container/VM | Last update  | Type      | Status     | Notes                                                                                                                                                                                                                                                                               |
| ---------------------------------------------------- | ------------ | ------------ | --------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Lomnia](https://lorenzomodolo.com/projects/lomnia/) | Lomnia       | Mar 22, 2026  | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Vaultwarden                                          | Confidant    | Mar 22, 2026 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Unifi controller                                     | Gatekeeper   | Nov 11, 2023 | VM        | Needs work | [Image moved (read og image message)](https://github.com/linuxserver/docker-unifi-network-application). But new image requires a separate mongodb instance... Need to check how it will affect the resources that I have to allocate for this in proxmox. No HyperBackup configured |
| Traefik                                              | RaspberryPi  | Nov 14, 2025 | Container | Working    | Has some logs about using deprecated syntax. Should probably take some time to drop this in favor of npm or npm in favour of traefik across the board                                                                                                                               |
| Syncthing                                            | Obsidian     | Nov 14, 2025 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Pihole                                               | Gatekeeper   | Mar 22, 2026 | VM        | Deprecated |                                                                                                                                                                                                                                                                                     |
| Technitium                                           | Gatekeeper   | Mar 22, 2026 | VM        | Working    |                                                                                                                                                                                                                                                                                     |
| NPM                                                  | Gatekeepr    | Mar 22, 2026 | VM        | Working    |                                                                                                                                                                                                                                                                                     |
| Spotify-Mongo                                        | Radioactive  |              | Container | Working    | Can't update because of Raspberry Pi's architecture                                                                                                                                                                                                                                 |
| Spotify Server                                       | RaspberryPi  | Nov 14, 2025 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Spotify Client                                       | RaspberryPi  | Nov 14, 2025 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Location Tracker                                     | L-tracker    | Feb 22, 2024 | Container | Deprecated | Read comments on Obsidian about docker compose version change and ansible. Assertion for running containers not working                                                                                                                                                             |
| Forgejo                                              | Forgejo      | Nov 23, 2024 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Lofinance                                            | lofinance    | Nov 30, 2024 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Hoarder                                              | hoarder      | Mar 22, 2026 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Dozzle                                               | dozzle       | Mar 22, 2026 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Uptime Kuma                                          | uptime-kuma  | Mar 22, 2026 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Mgob                                                 | mgob         | Dec 20, 2024 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Hares                                                | hares        | Jan 13, 2025 | Container | Offline    |                                                                                                                                                                                                                                                                                     |
| Owntracks recorder                                   | owntracks    | Mar 22, 2026 | Container | Working    |                                                                                                                                                                                                                                                                                     |
| Owntracks frontend                                   | owntracks    | Mar 22, 2026 | Container | Working    |                                                                                                                                                                                                                                                                                     |
